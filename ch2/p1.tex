...
\begin{enumerate}[leftmargin=*]
    ...
    \item Notice that the largest asymptotic value of $k$ is $k=\lg n$, because
        ...
        higher order term, equals to the worst case running time of merge sort
        in terms of $\Theta$ notation. Therefore, the largest value of $k$ is
        $\lg n$.
    \item $k$ should be the largest sublist length so that selection sort
        outperforms merge sort.
\end{enumerate}
